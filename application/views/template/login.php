...
<head>
    ...
    <!-- Bootstrap 4.4.1 -->
    <link rel="stylesheet" href="<?php echo base_url('assets/template/bower_components/bootstrap/dist/bootstrap.min.css') ?>">
    <!-- Font Awesome -->
...
<body class="hold-transition login-page">
    ...
    <!-- Bootstrap 4.4.1 -->
    <script src="<?php echo base_url('assets/template/bower_components/bootstrap/dist/bootstrap.bundle.min.js') ?>"></script>
    <!-- iCheck -->
