                            ...
                            <tbody>
                                ...
                                foreach ($penawaran->result() as $data) { ?>
                                    <tr>
                                        ...
                                        <td><button class="btn btn-primary" data-toggle="modal" data-target="#modal-produk-penawaran-<?php echo $i++ ?>" title="Lihat Produk Yang Ditawarkan"><i class="fa fa-info"></i></button> <button class="btn btn-success" onclick="approvePenawaran(<?php echo $data->pen_id ?>)" title="Setujui Penawaran"><i class="fa fa-check"></i></button> <button class="btn btn-danger" onclick="rejectPenawaran(<?php echo $data->pen_id ?>)" title="Tolak Penawaran"><i class="fa fa-times"></i></button></td>
                                    </tr>
                                <?php }
                                ?>
                            </tbody>
